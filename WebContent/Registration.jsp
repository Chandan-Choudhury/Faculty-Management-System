...
<body>
  ...
  <div class="nav-container">
    <nav>
      <div class="nav-wrapper #69f0ae green accent-2">
        <a href="FacultyLogin.jsp" class="brand-logo" style="padding-top: 10px;"><img src="Images/bcetlogo.png" alt="Bcet_Logo"></a>
      </div>
    </nav>
  </div>

  <!-- Registration Form -->
  <form action="Registrationprocess.jsp" method="post" onsubmit="return validation()">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <input id="name" type="text" name="name" class="validate" autocomplete="off" required pattern="^(?=[A-Za-z0-9])([A-Za-z0-9\s]*)(?<=[A-Za-z0-9])$">
      ...
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <input id="whatsapp" type="text" name="whatsapp" pattern="[7-9]{1}[0-9]{9}" class="validate" autocomplete="off" required>
  ...
  <footer class="page-footer #69f0ae green accent-2">
    ...
    <p class="grey-text text-lighten-4 right">Developed by: SDM and Team</p>
    </div>
  </footer>
